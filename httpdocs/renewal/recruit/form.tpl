				...
				<table class="tbl_form">
					<tbody>
						<tr class="first">
							...
							<td>
								{if !empty($message.ng.recruit)}<span class="error">※{$message.ng.recruit}</span>{/if}
								{html_radios name="recruit" options=$OptionRecruit selected=$arr_post.recruit|default:"1"}
							</td>
						</tr>
						<tr>
