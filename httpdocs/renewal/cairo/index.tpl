...
<div id="body">
	<div id="page_title" class="b_sh">
		<div><img src="{$_RENEWAL_DIR}/common/image/contents/cairo/top.jpg" alt="鮮度保持剤"></div>
	...
	<section class="top">
		<div class="pos_re mb20">
			<div class="shadow"><img src="{$_RENEWAL_DIR}/common/image/contents/cairo/cairo_p.jpg" alt=""></div>
