			...
			<div class="col-xs-4 height-1">
				<div class="page_link">
					<a href="{$_RENEWAL_DIR}/product/">
						<div class="photo"><img src="{$_RENEWAL_DIR}/common/image/contents/cairo/menu1.jpg" alt="鮮度保持材"></div>
			...
			<div class="col-xs-4 height-1">
				<div class="page_link">
					<a href="{$_RENEWAL_DIR}/way/">
						<div class="photo"><img src="{$_RENEWAL_DIR}/common/image/contents/cairo/menu2.jpg" alt="用途のご紹介"></div>
			...
			<div class="col-xs-4 height-1">
				<div class="page_link">
					<a href="{$_RENEWAL_DIR}/virtual/">
						<div class="photo"><img src="{$_RENEWAL_DIR}/common/image/contents/cairo/menu3.jpg" alt="バーチャル工場見学"></div>
