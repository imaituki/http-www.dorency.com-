...
class FT_contact {
	...
	function check( &$arrVal ) {
		...
		// チェックエントリー
		$objInputCheck->entryData( "会社名", "company", $arrVal["company"], array( "CHECK_EMPTY", "CHECK_MIN_MAX_LEN" ), 0, 255 );
		$objInputCheck->entryData( "ご担当者名", "name", $arrVal["name"], array( "CHECK_EMPTY", "CHECK_MIN_MAX_LEN" ), 0, 255 );
