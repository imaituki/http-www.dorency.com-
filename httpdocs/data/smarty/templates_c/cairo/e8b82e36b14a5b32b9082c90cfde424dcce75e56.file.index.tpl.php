...
<?php /*%%SmartyHeaderCode:14169165925e30cc30d49812-44810776%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '14169165925e30cc30d49812-44810776',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5e30cc30db07f9_56399058',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5e30cc30db07f9_56399058')) {function content_5e30cc30db07f9_56399058($_smarty_tpl) {?><!DOCTYPE html>
<html lang="ja">
<head>
<meta charset="utf-8">
...
/common/image/contents/cairo/top.jpg" alt="楽々カイロ 使い捨てカイロ"></div>
		<div class="page_title_wrap">
			<div class="center">
				<div class="disp_td">
					<h2 class="mincho">楽々カイロ<span class="sub">使い捨てカイロ</span></h2>
				</div>
			</div>
		</div>
	</div>
...
/common/image/contents/cairo/cairo_p.jpg" alt="楽々カイロ 使い捨てカイロ"></div>
			<div class="text">
				<div class="center">
					<div class="disp_td">
						<p class="mb20">[カイロ]</p>
						<h2 class="cg mb20">すぐに温まりたい人必携<br>常に高温を維持<br>即効性をアピールした文章がはいります。</h2>
...
/common/image/contents/top/cairo.png" alt="楽々カイロ"></div>
	...
	<section>
		<div class="wrapper-t center">
			<h2 class="hl_4"><span>楽々カイロの用途</span></h2>
			<div class="row">
...
/common/image/contents/cairo/way4.jpg" alt="夏場のクーラーの冷えすぎに">
	...
	<section>
		<div class="wrapper-t center">
			<h2 class="hl_4"><span>楽々カイロの種類</span></h2>
			<div class="row mb50">
				<div class="col-xs-3">
...
/common/image/contents/cairo/type1.jpg" alt="貼るタイプ　レギュラー"></p>
				...
				<div class="col-xs-3">
					<p class="mb10"><img src="<?php echo $_smarty_tpl->tpl_vars['_RENEWAL_DIR']->value;?>
/common/image/contents/cairo/type2.jpg" alt="貼らないタイプ　レギュラー"></p>
					<p class="pos_ac">貼らないタイプ　レギュラー</p>
				</div>
				<div class="col-xs-3">
					<p class="mb10"><img src="<?php echo $_smarty_tpl->tpl_vars['_RENEWAL_DIR']->value;?>
/common/image/contents/cairo/type3.jpg" alt="貼るタイプ　ミニ"></p>
					<p class="pos_ac">貼るタイプ　ミニ</p>
				</div>
				<div class="col-xs-3">
					<p class="mb10"><img src="<?php echo $_smarty_tpl->tpl_vars['_RENEWAL_DIR']->value;?>
/common/image/contents/cairo/type4.jpg" alt="貼らないタイプ　ミニ"></p>
	...
	<section>
		<div class="center wrapper-t">
			<h2 class="hl_4"><span>楽々カイロに関するお問い合わせ</span></h2>
