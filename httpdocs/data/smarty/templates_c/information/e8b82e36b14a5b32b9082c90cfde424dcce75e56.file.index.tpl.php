<?php /* Smarty version Smarty-3.1.18, created on 2019-12-20 18:Dec:th
         compiled from "./index.tpl" */ ?>
<?php /*%%SmartyHeaderCode:21209323085dfc91fb62b3c8-79495680%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '21209323085dfc91fb62b3c8-79495680',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5dfc91fb710a22_01328063',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5dfc91fb710a22_01328063')) {function content_5dfc91fb710a22_01328063($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_date_format')) include '/var/www/vhosts/dorency.com/httpdocs/data/smarty/libs/plugins/modifier.date_format.php';
?><!DOCTYPE html>
<html lang="ja">
<head>
<meta charset="utf-8">
...
GoogleMap">[GoogleMap]</a>
								...
								<div class="col-xs-5">
									<div class="photo img_back height-1"><img src="<?php if ($_smarty_tpl->tpl_vars['base']->value['image1']) {?><?php echo $_smarty_tpl->tpl_vars['_RENEWAL_DIR']->value;?>
/common/photo/base/image1/m_<?php echo $_smarty_tpl->tpl_vars['base']->value['image1'];?>
<?php }?>" alt="<?php echo $_smarty_tpl->tpl_vars['base']->value['name'];?>
"></div>
								</div>
							</div>
						</div>
	...
	<section>
		<div id="reserch" class="wrapper">
			<h2 class="hl_1">研究開発<span class="sub">Research and Development</span></h2>
	...
	<section>
		<div id="factory" class="wrapper">
			<div class="center">
				<div class="row no-gutters">
					<div class="col-xs-4">
						<h2 class="hl_1 pos_al">生産工場<span class="sub">Factory</span></h2>
...
/common/image/contents/top/image6.png" alt="">
	...
	<section>
		<div id="brand" class="wrapper">
			<div class="center">
				<h2 class="hl_1">ドレンシーブランド・製品情報<span class="sub">Brand and Items</span></h2>
				<div class="box">
					<div class="row no-gutters">
...
/common/image/contents/top/brand_k1.jpg" alt=""></div>
						...
						<div class="col-xs-2-5">
							<div class="text height-1">
								...
								<p>品の酸化を防ぎ、鮮度を保つ脱酸素剤。寒い日にカラダを優しく温めてくれるカイロ。1985年（昭和61年）の創業以来、ドレンシー株式会社は。</p>
							</div>
						</div>
						<div class="col-xs-2-5">
							<div class="photo img_back height-1"><img src="<?php echo $_smarty_tpl->tpl_vars['_RENEWAL_DIR']->value;?>
...
/common/image/contents/top/brand_k2.jpg" alt=""></div>
						...
						<div class="col-xs-2-5">
							<div class="text height-1">
								<h3>X線対応脱酸素剤/アルコール揮散剤</h3>
								<p>食品の酸化を防ぎ、鮮度を保つ脱酸素剤。寒い日にカラダを優しく温めてくれるカイロ。1985年（昭和61年）の創業以来、ドレンシー株式会社は。</p>
							</div>
						</div>
						<div class="col-xs-2-5">
							<div class="photo img_back height-1"><img src="<?php echo $_smarty_tpl->tpl_vars['_RENEWAL_DIR']->value;?>
...
/common/image/contents/top/d3.jpg" alt=""></div>
				...
				<div class="box mb50">
					<div class="row no-gutters">
						<div class="col-xs-1-5">
							<div class="photo img_back height-1"><img src="https://placehold.jp/600x600.png" alt=""></div>
						</div>
						<div class="col-xs-2-5">
							<div class="text height-1">
								<h3>電子レンジ対応脱酸素剤</h3>
...
/common/image/contents/top/recruit.jpg" alt="採用情報"></a>
	...
	<section>
		<div id="top_info" class="wrapper">
			<div class="center">
				<div class="hl_2">
					<h2>お知らせ<span class="sub">NEWS</span></h2>
