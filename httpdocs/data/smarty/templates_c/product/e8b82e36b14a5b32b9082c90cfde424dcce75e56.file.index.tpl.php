...
<?php /*%%SmartyHeaderCode:18430648945e30cc6e74c358-77578668%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '18430648945e30cc6e74c358-77578668',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5e30cc6e7c1a03_64706679',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5e30cc6e7c1a03_64706679')) {function content_5e30cc6e7c1a03_64706679($_smarty_tpl) {?><!DOCTYPE html>
<html lang="ja">
<head>
<meta charset="utf-8">
...
/common/image/contents/product/product_p.jpg" alt="脱酸素剤 キーピット"></div>
			<div class="text">
				<div class="center">
					<div class="disp_td">
						<p class="mb20">[脱酸素剤]</p>
						<h2 class="cg mb20">脱酸素剤「キーピット」は<br>酸素ゼロの状態をつくり<br>食品の安心・安全とおいしさを創り出します</h2>
						<div><img src="<?php echo $_smarty_tpl->tpl_vars['_RENEWAL_DIR']->value;?>
/common/image/contents/product/product.png" alt="脱酸素剤 キーピット"></div>
					</div>
				</div>
			</div>
		</div>
		<div class="bg1 wrapper-t">
			<div class="center">
				<p>キーピットは、鉄が酸化して錆びるときに酸素を吸収する働きを利用した、鉄粉系の脱酸素剤です。<br>
