			<form class="form-horizontal" action="./{if $mode == 'edit'}update{else}insert{/if}.php" method="post" enctype="multipart/form-data" id="inputForm">
				<div class="ibox-content">
					<div class="form-product required">
						...
						<div class="col-sm-6">
							...
							<div class="radio m-r-xs inline">
								<select class="form-control" name="id_product_category" id="id_product_category">
									...
									{html_options options=$OptionGroupCategory selected=$arr_post.id_product_category}
								</select>
							</div>
						</div>
					</div>
					...
					<div id="item_container">
						{foreach from=$arr_post.detail item="product_parts" key="key" name="loopMonthList"}
