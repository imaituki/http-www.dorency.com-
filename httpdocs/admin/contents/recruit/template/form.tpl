				...
				<div class="ibox-content">
					...
					<div class="form-group required">
						...
						<div class="col-sm-6">
							...
							<input type="text" class="form-control" name="title" id="title" value="{$arr_post.title|default:""}" maxlength="255" />
						</div>
					</div>
					...
					<div class="form-group required">
						...
						<div class="col-sm-6">
							...
							<div class="radio m-r-xs inline">
								{html_radios name="employment" options=$OptionEmployment selected=$arr_post.employment|default:"FULL_TIME"}
							</div>
						</div>
					</div>
					<div class="hr-line-dashed"></div>
					...
					<div class="form-group">
						...
						<div class="col-sm-4">
							<div class="radio m-r-xs inline mb15">
								{html_radios name="display_indefinite_flg" values=1 selected=$arr_post.display_indefinite_flg|default:"1" output="設定しない"}&nbsp;&nbsp;
								{html_radios name="display_indefinite_flg" values=0 selected=$arr_post.display_indefinite_flg|default:"1" output="設定する"}
							</div>
