<?php /* Smarty version Smarty-3.1.18, created on 2019-11-22 12:37:34
...
<?php if ($_valid && !is_callable('content_5dccf176581ed0_11845040')) {function content_5dccf176581ed0_11845040($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_date_format')) include '/home/brownotter8/data/smarty/libs/plugins/modifier.date_format.php';
?><!DOCTYPE html>
<html lang="ja">
<head>
<meta charset="utf-8">
...
<div id="top_main">
	<div id="main_image">
		<div class="unit">
			<div class="img_back"><img src="/common/image/contents/top/slide1.jpg" alt="R・Fマネージメント株式会社"></div>
			<div class="text _right img_back"><img src="/common/image/contents/top/text1.png" alt=""></div>
		</div>
		<div class="unit">
			<div class="img_back"><img src="/common/image/contents/top/slide2.jpg" alt="R・Fマネージメント株式会社"></div>
			<div class="text img_back"><img src="/common/image/contents/top/text1.png" alt=""></div>
		</div>
		<div class="unit">
			<div class="img_back"><img src="/common/image/contents/top/slide1.jpg" alt="R・Fマネージメント株式会社"></div>
			<div class="text _right img_back"><img src="/common/image/contents/top/text1.png" alt=""></div>
...
<div id="body">
	<section>
		<div id="top_contents" class="wrapper bg_dot">
			<div class="center2">
				<h2 class="cb"><span class="sub">R・Fマネージメント株式会社は、<br class="visible-xs">相続対策・年金相談を専門とする</span><span class="main">ファイナンシャル<br class="visible-xs">プランナー<br class="visible-sm-only">事務所です</span></h2>
				<p>当事務所では、ファイナンシャルプランナーが相続セミナーを通じて長生きや介護、相続に備えての事前準備の必要性を情報発信しております。セミナーでは、相続に関する全体像を学んでいただき、優遇税制などの活用方法をわかりやすく丁寧に解説いたします。「ホントに知ってよかった」と思っていただけるように、受講者様が自ら問題解決に向けて行動していただけるように、実践的な対策方法をお伝えしております。</p>
			</div>
		</div>
	</section>
	<section>
		<div id="top_menu" class="wrapper bg_town">
			<div class="center">
				<div class="row">
					<div class="col-xs-6">
						<div class="photo_link">
							<a href="/for_person/">
								<div class="photo img_back bor10"><img src="/common/image/contents/top/image2.jpg" alt="生前相続対策・生前贈与"></div>
								<div class="text">
									<h2><span class="disp_td">生前相続対策<br class="visible-xs">・生前贈与</span></h2>
								</div>
								<div class="caption bg_blue">個人／相続対策・生前贈与</div>
							</a>
						</div>
					</div>
					<div class="col-xs-6">
						<div class="photo_link">
							<a href="/for_business/">
								<div class="photo img_back bor10"><img src="/common/image/contents/top/image1.jpg" alt="企業財務体質強化・相続事業承継"></div>
								<div class="text">
									<h2><span class="disp_td">企業財務体質強化<br class="visible-sm">・相続事業承継</span></h2>
								</div>
								<div class="caption bg_blue">法人／経営者の方</div>
							</a>
						</div>
					</div>
				</div>
				<div class="row">
					<div class="col-xs-4">
						<div class="photo_link">
							<a href="/flow/">
								<div class="photo img_back bor10"><img src="/common/image/contents/top/image3.jpg" alt="ご相談の流れ"></div>
								<div class="caption bg_lblue">ご相談の流れ</div>
							</a>
						</div>
					</div>
					<div class="col-xs-4">
						<div class="photo_link">
							<a href="/case/">
								<div class="photo img_back bor10"><img src="/common/image/contents/top/image4.jpg" alt="ご相談事例"></div>
								<div class="caption bg_lblue">ご相談事例</div>
							</a>
						</div>
					</div>
					<div class="col-xs-4">
						<div class="photo_link">
							<a href="/company/">
								<div class="photo img_back bor10"><img src="/common/image/contents/top/image5.jpg" alt="会社概要"></div>
								<div class="caption bg_lblue">会社概要</div>
							</a>
						</div>
					</div>
				</div>
	...
	<section>
		<div id="top_seminar" class="wrapper bg_gray">
			<div class="center">
				<h2 class="hl_1"><span class="bg_gray">セミナー実績<span class="sub">Seminar information</span></span></h2>
				<div class="row mb50">
					<div class="col-sm-5 mb30">
						<div class="seminar_navi tab_sort" data-tab="seminar_unit_wrap">
							<ul class="period">
								<li><a href="javascript:void(0)" data-flg="0">すべて表示</a></li>
								<li><a href="javascript:void(0)" data-flg="1">開催予定</a></li>
								<li><a href="javascript:void(0)" data-flg="2">開催中</a></li>
								<li><a href="javascript:void(0)" data-flg="3">開催済</a></li>
							</ul>
						</div>
					</div>
					<div class="col-sm-7">
...
?>
						...
						<div class="seminar_navi mb10 tab_sort" data-tab="seminar_unit_wrap">
						<ul>
						<?php }?>
							<li><a href="javascript:void(0)" data-id="<?php echo $_smarty_tpl->tpl_vars['key']->value;?>
"><?php echo $_smarty_tpl->tpl_vars['seminar_category']->value;?>
</a></li>
...
?>
					<div class="col-sm-4 col-xs-6 seminar_unit_wrap" <?php if (smarty_modifier_date_format($_smarty_tpl->tpl_vars['seminar']->value['date_start'],"%Y-%m-%d %H:%M:%S")>smarty_modifier_date_format(time(),"%Y-%m-%d %H:%M:%S")) {?> data-flg="1"<?php } elseif (smarty_modifier_date_format($_smarty_tpl->tpl_vars['seminar']->value['date_start'],"%Y-%m-%d %H:%M:%S")<=smarty_modifier_date_format(time(),"%Y-%m-%d %H:%M:%S")&&smarty_modifier_date_format(time(),"%Y-%m-%d %H:%M:%S")<=smarty_modifier_date_format($_smarty_tpl->tpl_vars['seminar']->value['date_end'],"%Y-%m-%d %H:%M:%S")) {?> data-flg="2" <?php } elseif (smarty_modifier_date_format($_smarty_tpl->tpl_vars['seminar']->value['date_end'],"%Y-%m-%d %H:%M:%S")<smarty_modifier_date_format(time(),"%Y-%m-%d %H:%M:%S")) {?> data-flg="3" <?php }?> data-id="<?php echo $_smarty_tpl->tpl_vars['seminar']->value['seminar_category'];?>
">
						<div class="seminar_unit">
							<a href="/seminar/detail.php?id=<?php echo $_smarty_tpl->tpl_vars['seminar']->value['id_seminar'];?>
">
...
?>
					<div class="pos_ac">セミナー実績をもっと見る</div>
					<?php } ?>
				</div>
				<div class="pos_ac"><a href="/seminar/" class="button _more">セミナー実績をもっと見る<i class="fa fa-arrow-right"></i></a></div>
			</div>
		</div>
	</section>
	<section>
		<div id="top_info" class="wrapper">
			<div class="center box">
				<div class="hl_2">
					<h2>Information</h2>
					<div class="right"><a href="/information/"><i class="fa fa-arrow-right"></i>過去の履歴を見る</a></div>
				</div>
				<div class="info_list">
